...
class KitManager {
    ...
    public function getKitStaff(Player $player) {
        ...
        $warn = ItemFactory::getInstance()->get(369, 0, 1);
        $warn->setCustomName(TextFormat::colorize("&9Warn Player(s)"));
        $warn->getNamedTag()->setString("staff-tool", "staff-tools");
        ...
        $player->getInventory()->setItem(4, $warn);
